...
8. Identify duplicate or apparently reusable resources, but do not assume matching names are semantically equivalent.
9. Report findings by severity with resource type, name, ID, evidence, impact, and recommended next action.

State these blind spots in the report: this MCP cannot simulate profile eligibility or delivery, inspect every campaign or journey policy reference, author Decision Policies, bind placements, proof content, or activate campaigns and journeys.
